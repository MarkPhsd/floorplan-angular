            ...
            if (json.objects) {
                if (json.objects.length > 0) {
                    json.objects.forEach(data => {
                        console.log('alterObjectColor data?.backgroundColor', data === null || data === void 0 ? void 0 : data.backgroundColor);
                        if ((data === null || data === void 0 ? void 0 : data.name) === name) {
                            if ((data === null || data === void 0 ? void 0 : data.backgroundColor) === 'purple' || (data === null || data === void 0 ? void 0 : data.backgroundColor) === 'rgba(255,100,171,0.25)') {
...
class ViewComponent {
    ...
    saveAs(format) {
        ...
        const credit = new fabric.Text(RL_CREDIT_TEXT, Object.assign(Object.assign({}, RL_CREDIT_TEXT_PARAMS), { left: RL_ROOM_OUTER_SPACING, top: bottom + RL_ROOM_OUTER_SPACING - RL_CREDIT_TEXT_PARAMS.fontSize }));
